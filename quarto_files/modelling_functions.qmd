# Modelling functions {#sec-mod_funcs .unnumbered}

Here all functions used for modelling and model specific data-preprocessing, as well as model evaluation and plotting.
...
[Full Modelling Process](#sec-full)
...
## Plotting {#sec-plot}
```{.python include="../scripts/modelling_functions.py" code-line-numbers="true" start-line=595 code-fold="true" }
```