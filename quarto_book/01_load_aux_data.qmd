...
```{.python include="../scripts/01_load_aux_data.py" code-line-numbers="true" start-line=3 end-line=11 code-fold="true" }
```
...
```{.python include="../scripts/01_load_aux_data.py" code-line-numbers="true" start-line=16 end-line=88 code-fold="true" }
```


## Run the functions

```{.python include="../scripts/01_load_aux_data.py" code-line-numbers="true" start-line=94 end-line=108 code-fold="true" }
