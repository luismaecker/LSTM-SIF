...
```{.python include="../scripts/load_aux_data_01.py" code-line-numbers="true" start-line=3 end-line=11 code-fold="true" }
```
...
```{.python include="../scripts/load_aux_data_01.py" code-line-numbers="true" start-line=16 end-line=88 code-fold="true" }
```


## Run the functions

```{.python include="../scripts/load_aux_data_01.py" code-line-numbers="true" start-line=94 end-line=108 code-fold="true" }
