...
```{.python include="../scripts/03_base_analysis.py" code-line-numbers="true" start-line=0 end-line=143 code-fold="true" }
```


## Run the script

```{.python include="../scripts/03_base_analysis.py" code-line-numbers="true" start-line=3 end-line=108 code-fold="true" }
```