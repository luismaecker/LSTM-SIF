...
```{.python include="../scripts/02_cube_preprocessing.py" code-line-numbers="true" start-line=0 end-line=143 code-fold="true" }
```


## Run the script

```{.python include="../scripts/02_cube_preprocessing.py" code-line-numbers="true" start-line=145 code-fold="true" }
```